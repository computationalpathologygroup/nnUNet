...
from batchgenerators.transforms.color_transforms import GammaTransform, BrightnessMultiplicativeTransform, \
...
from nnunet.training.network_training.diag.transforms.spatial_transforms import SpatialTransformWithWeights, MirrorTransformWithWeights
from nnunet.training.network_training.diag.transforms.custom_transforms import Convert2DTo3DTransformWithWeights, Convert3DTo2DTransformWithWeights

from nnunet.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params
from nnunet.training.data_augmentation.custom_transforms import MaskTransform, ConvertSegmentationToRegionsTransform
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    tr_transforms.append(SpatialTransformWithWeights(
    ...
    if deep_supervision_scales is not None:
        ...
        tr_transforms.append(DownsampleSegForDSTransform2(ds_scales=deep_supervision_scales, order=1, input_key='weightmap',
